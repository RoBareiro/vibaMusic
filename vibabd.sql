...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-11-2016 a las 20:15:02
...
(1, 25, 'Este será enviado al Email correspondiente', '16-11-29');
...
(1, 'Greedy', 1, 'Dangerous Woman', '3:35', 1, '../uploads/Greedy.mp3'),
(2, 'Kiss It Better', 2, 'ANTI', '4:13', 3, '../uploads/Kiss It Better.mp3'),
(3, 'Bacon', 3, 'Last Year Was Complicated', '3:02', 1, '../uploads/Bacon.mp3'),
(4, 'Chantaje', 4, 'Chantaje Single', '3:16', 6, '../uploads/Chantaje.mp3'),
(5, 'Hotline Bling', 5, 'Views', '4:27', 3, '../uploads/Hotline Bling.mp3'),
(6, 'Safari', 7, 'Energía', '3:24', 6, '../uploads/Safari.mp3'),
(7, 'Starboy', 6, 'Starboy Single', '3:50', 9, '../uploads/Starboy.mp3'),
(8, 'Body Moves', 8, 'DNCE', '3:56', 1, '../uploads/Body Moves.mp3');
...
CREATE TABLE `playlist` (
  ...
  `codigo_qr` varchar(200) COLLATE utf8_bin NOT NULL,
...
(90, 24, 1, 0, 'Pop', '0', '2016-11-25', '../imgPlaylist/667389pop1.jpg', 'NULL', 'privada'),
...
(102, 23, 6, 0, 'exportar', '', '2016-11-29', '../imgPlaylist/690094playlist.jpg', 'NULL', 'publica');
...
INSERT INTO `voto` (`id_voto`, `id_playlist`, `id_usuario`) VALUES
(1, 89, 26),
(2, 88, 26),
(3, 90, 26),
(4, 91, 26),
...
--
ALTER TABLE `artista`
  MODIFY `idArtista` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
--
...
--
ALTER TABLE `cancion`
  MODIFY `idCancion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
--
...
--
ALTER TABLE `playlist`
  MODIFY `id_playlist` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=103;
--
-- AUTO_INCREMENT de la tabla `sigue_a`
--
ALTER TABLE `sigue_a`
  MODIFY `id_seguimiento` int(255) NOT NULL AUTO_INCREMENT COMMENT 'NOS FALTO AGREGAR ESTO', AUTO_INCREMENT=61;
--
