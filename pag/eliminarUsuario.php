		...
		<div class="container">
			...
			<div class="banner-info">
				<div class="container">
					...
					<form class="formulario wow bounceIn" data-wow-delay="0.4s" method="POST" action="eliminarUsuario.php">
							</br>
							<h3><font color='red'>¿ESTA SEGURO QUE DESEA ELIMINAR EL USUARIO?</font></h3>
							</br>
							<input class="botonlogin" type="submit" name="eliminarUsuario" value="ELIMINAR"></input>
					</form>
				</div>
			</div>
